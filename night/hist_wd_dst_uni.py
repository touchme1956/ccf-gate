...
limits = {
    "survivorship_delisting": {
        ...
        "measured_elsewhere": ("out/retro_delisted_secpx_2013.json（2013・price-only）の実測: "
                               "survivorのみ 恒久毀損 56/981=5.71% → 退場45社を復元して 58/1026=5.65%。"
                               "ただし**まだ762社が打ち切り**。CLAUDE.md の別の実測では退場175社のうち"
                               "139社(79%)がM&A退場＝プレミアム付きで消えている。"),
        ...
        "direction_of_bias": ("**この道具では決められない**。退場には (a)破綻して消える＝破壊率を過小に見せる "
                              ...
                              "実測は(b)が79%と多い。よって size 効果が過大か過小かは断定できない。"),
    },
