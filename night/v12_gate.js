...
const RFR = 5.01, ERP = 4.45, BETA_DFLT = 1.0;  // ⚠ v9(index.html)と同じ値に揃える
//   ——2026-09-18 に門の既定が 4.68→5.01 へ月次更新されたので here も追随した（片方だけ動かすと同じ台帳を見る二つの門が違う資本コストで裁く・v9.9.65）。
//   揃えないと **同じ台帳を見る二つの門が違う資本コストで裁く**（v9.9.65 の破れ）。
