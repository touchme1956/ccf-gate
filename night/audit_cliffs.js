...
const RULES = [
  ...
  { n: "Z''<2.6 グレー −6",          sz: '−6',  k: 'z',          on: 2.0,    off: 4,     is: v => v != null && +v >= 1.1 && +v < 2.6 },
  { n: 'ROIIC³ WACC近傍 −8',         sz: '−8',  k: 'roiic',      on: 10,     off: 40,    is: v => v != null && v !== 'na' && +v >= 11 && +v < 13 },
  { n: 'GP/A<15 −5',                 sz: '−5',  k: 'gpa',        on: 10,     off: 30,    is: v => v != null && +v < 15 },
...
const TESTED = {
  ...
  "Z''<2.6 グレー −6":         ['fail', '2026-09-23 事前登録・**3ビンテージとも毀損が逆**（灰色帯のほうが毀損が薄い 0.013/0/0.05 vs 0.042/0.021/0.065）＝歴史は −6 を支持しない'],
  ...
  'GP/A<15 −5':               ['fail', '2026-09-23 事前登録・2013/2018は両方向だが **2015で中央値が逆**（9.1% vs 8.7%）。補助5年でも両方向は2/5＝向きが安定しない'],
